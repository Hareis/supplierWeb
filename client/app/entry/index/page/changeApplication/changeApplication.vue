            ...
            <el-card class="box-card">
                ...
                <div class="order_search">
                    <el-row>
                        <el-col :span="8">
                            <span>订单号：</span>
                            <el-input size="small" class="noneBorder" v-model="tabledata.orderId"
                        ...
                        <el-col :span="8">
                            <span>PNR：</span>
                            <el-input size="small" class="noneBorder" v-model="tabledata.pnr"
                                      :readonly="true"></el-input>
                        </el-col>
                        <el-col :span="8">
                            <span>支付时间：</span>
                        ...
                        <el-col :span="8">
                            <span>支付金额：</span>
                            <el-input size="small" class="noneBorder" v-model="payAmount" :readonly="true"></el-input>
                        </el-col>
                        <el-col :span="8">
                            <span>订单状态：</span>
                            <el-input size="small" class="noneBorder" v-model="mainStatusCn"
                                      :readonly="true"></el-input>
                        </el-col>
                        <el-col :span="8">
                            <span>出票时间：</span>
            ...
            <el-card class="box-card">
                ...
                <div class="range_info">
                    ...
                    <el-table ref="multipleTable" :data="segments" tooltip-effect="dark" style="width: 100%"
                        ...
                        <el-table-column label="新起飞日期" width="200px">
                            <template scope="scope">
                                <el-date-picker size="small" id="newDepDatetime" v-model.trim="scope.row.newDepDatetime"
                        ...
                        <el-table-column label="新航班号" width="120px">
                            <template scope="scope">
                                <el-input size="small" v-model.trim="scope.row.newFlightNumber" :maxlength="6">
                                </el-input>
                            </template>

                        </el-table-column>

                        <el-table-column label="新舱位" width="70px">

                            <template scope="scope">
                                <el-input size="small" v-model.trim="scope.row.newCabin" :maxlength="2">
                                </el-input>
                            </template>
                ...
                <div>
                    <el-row>
                        <el-col :span="8" :offset="16">
                            ...
                            <el-button type="warning" style="float:right;margin-right:15px;" @click="submitApplication">
                                提交
                            </el-button>
    ...
    export default {
        ...
        methods: {
            ...
            async submitApplication() {
                try {
                    ...
                    for (let item of _self.segmentsList) {

                        if (item.newDepDatetime == undefined || item.newDepDatetime.length < 1) {
                            _self.$message.error('所选改期航班的,新起飞时间不能为空');
                            return false;
                        }
                        if (_self.isRTPNROrder || !_self.isShopingOrder) {

                            if (item.newFlightNumber == undefined || item.newFlightNumber.length < 1) {
                                _self.$message.error('所选改期航段的,新航班号不能为空');
                                return false;
                            }
                        }
                        if (!_self.isRTPNROrder && !_self.isShopingOrder) {

                            if (item.newCabin == undefined || item.newCabin.length < 1) {
                                _self.$message.error('所选改期航段的,新舱位不能为空');
                                return false;
                            }
                        }
                    }
                    ...
                    $.ajax({
                        ...
                        if (data.success) {
                            ...
                            var changeOrderId = data.orderId
                            _self.$router.push({
                                path: '/changeResult',
                                replace: true,
                                query: {orderId: changeOrderId}
                            });
                        }
                        else {
        ...
        async created() {
            ...
            try {
                ...
                this.segments = res.order.segments.map(e=>Object.assign({
                    newDepDatetime: '',
                    newFlightNumber: '',
                    newCabin: ''
                },e));
