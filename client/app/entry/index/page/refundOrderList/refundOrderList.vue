            ...
            <el-card>
                <div class="passenger_info">
                    <div>
                        <div style="margin-bottom: 10px">
                            <el-radio-group v-model="orderquest.mainStatus" size="small"
                                ...
                                <el-radio-button v-for="item in refundStatusOptions" :label="item.value.toString()"
                                                 v-bind:key="item.refundStatusOptions">
                    ...
                    <el-table :data="tabledata1" type="expand" border style="width: 100%">
                        ...
                        <el-table-column label="提交退票申请时间" width="89px">
                            <template scope="tabledata1">
                        ...
                        <el-table-column label="航程信息" width="100px">
                            <template scope="tabledata1">
                                <div :key="itinerary.$index"
                                    ...
                                    <div>
                                        <span v-html="itinerary.depAirport"></span>&nbsp;<span
                                            v-html="itinerary.depDatetime"></span>
                                    </div>
                                    <div>
                                    ...
                                    ->
                                    <div>
                                        <span v-html="itinerary.arrAirport"></span> &nbsp;<span
                                            v-html="itinerary.arrDatetime"></span>
                                    </div>
                                    <div>
                            ...
                            <template scope="tabledata1">
                                <div>
                                    <label>
                                        ...
                                        {{(tabledata1.row.sourceAdultPrice+tabledata1.row.sourceAdultTax
                                        )*tabledata1.row.adultNumber+(tabledata1.row.sourceChildPrice+tabledata1.row.sourceChildTax
                        ...
                        >
                            <template scope="scope">
                                <div class="order_status_btn">
                                    ...
                                    <span v-if="scope.row.mainStatus=='1'">退票申请中</span>
                                    <span v-if="scope.row.mainStatus=='2'">退票待确认</span>
                                    <span v-if="scope.row.mainStatus=='3'">退票已确认</span>
                                    <span v-if="scope.row.mainStatus=='4'">退票已取消</span>
                                    <span v-if="scope.row.mainStatus=='5'">待退款</span>
                                    <span v-if="scope.row.mainStatus=='6'">退票已完成</span>
                                    <span v-if="scope.row.mainStatus=='61'">退款中(待退款)</span>
                                </div>
                                <div>
                                    <el-button type="text" size="small" @click="getRefundDetails(scope.row)"
                                               class="operation_btn">退票详情
                                    </el-button>
                                </div>
                                <div>
            ...
            <el-form ref="form" :model="detalisData1" label-width="80px">
                ...
                <el-card class="box-card">
                    ...
                    <div class="order_search">
                        <el-row>
                            ...
                            <el-col :span="8">
                                <span>支付金额:</span>
                                <el-input size="small" class="noneBorder" :value="payAmount"
                                          :readonly="true"></el-input>
                            </el-col>
                            <el-col :span="8">
                                <span>订单状态:</span>
                                <el-input size="small" class="noneBorder" :value="mainStatusCn"
                                          :readonly="true"></el-input>
                            </el-col>
                            <el-col :span="8">
                                <span>出票时间:</span>
                                <el-input size="small" class="noneBorder" v-model="detalisData1.ticketTime"
                                          :readonly="true"></el-input>
                            </el-col>
                            <el-col :span="8">
                                <span>支付流水号:</span>
                                <el-input size="small" class="noneBorder" v-model="detalisData1.paymentVoucher"
                                          :readonly="true"></el-input>
                            </el-col>
                        </el-row>
                    </div>
                ...
                <el-card class="box-card">
                    ...
                    <div class="range_info">
                        ...
                        <el-table ref="multipleTable" :data="detalisData1.segments" tooltip-effect="dark"
                                  style="width: 100%">
                ...
                <el-card class="box-card">
                    ...
                    <div class="passenger_info">
                        ...
                        <el-table ref="multipleTable" :data="detalisData1.passengers" tooltip-effect="dark"
                                  style="width: 100%">
                    ...
                    <el-row style="margin-top:10px;">
                        <el-col>
                            <div style="float:right;margin-right:50px;">
                                机票价格： <label
                                    style="font-size:30px;color:#ff8247">&yen;{{(detalisData1.childPrice +
                                detalisData1.childTax) * (detalisData1.childNumber)+(detalisData1.adultPrice +
    ...
    export default {
        data() {
            return {
                ...
                refundStatusOptions: [
                    {name: "全部", key: "", value: ""},
                    {name: "退票申请中", key: "apply", value: "1"},
                    {name: "退票待确认", key: "answer", value: "2"},
                    {name: "退票已确认", key: "confirmed", value: "3"},
                    {name: "退票已取消", key: "cancel", value: "4"},
                    {name: "待退款", key: "ticket", value: "5_61"},
                    {name: "退票已完成", key: "finish", value: "6"},
                ],
                orderStatus: {},
                detalisData1: [],
                contact: {},
        ...
        methods: {
            ...
            async getRefundOrderStatus() {
                try {
                    const res = await requestAPIServiceAsync("/refund/getRefundOrderStatus.do", {refundType: 1});
