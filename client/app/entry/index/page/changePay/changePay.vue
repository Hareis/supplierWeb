            ...
            <div class="changePayDiv">
                ...
                <div class="payinfo">
                    ...
                    <div class="payinfo_body">
                        ...
                        <span class="payText" v-if="orderId != null">{{orderId}}</span>
                        <span class="payText" v-if="orderId == null">无</span>
                        <span class="payName">公司名称:</span>
                        <source>
                        <span class="payText" v-if="company != null">{{company}}</span>
                        <span class="payText" v-if="company == null">无</span>
...
<script>
    ...
    var currentOrderId = getQueryStringByName("orderId")
    ...
    export default {
        ...
        methods: {
            ...
            async otherPay(payType) {
                try {
                    var res = await APIService('/payment/otherPaymentType.do', {
                    ...
                    if (res.success) {
                        ...
                        this.$router.push({path: "/orderList", query: {orderId: this.$route.query.orderId}});
                    }
                    else {
            ...
            async aliPay() {
                try {
                    var res = await APIService('/payment/payment.do', {
        ...
        async created() {
            try {
                var res = await APIService('/accounting/prerequire.do', {orderId: this.$route.query.orderId});
            ...
            this.intervalid1 = setInterval(() => {
                ...
                if (this.bookingDatetime != null && this.hasRemain) {
                    ...
                    if (this.remainingTimeStr == "") {
                        ...
                        //支付超时 更新订单状态
                        this.payTimeOutUpdateOrderStatus();
