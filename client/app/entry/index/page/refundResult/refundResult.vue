    ...
    <div class="bgColor">
        <div class="container ">
            ...
            <el-card class="box-card" v-if="tabledata.mainStatus==6">
                <el-row>
                    <el-col :span="12" style="font-size:2.2rem;color:green">
                        <i class="el-icon-success"></i> 退票成功
                    </el-col>
             ...
             <el-card class="box-card" v-if="tabledata.mainStatus==5">
                <el-row>
                    <el-col :span="12" style="font-size:2.2rem;color:green">
                        <i class="el-icon-success"></i>  退票操作完成(待退款)
                    </el-col>
            ...
            <el-card class="box-card" v-if="tabledata.mainStatus==61">
                <el-row>
                    <el-col :span="12" style="font-size:2.2rem;color:green">
                        <i class="el-icon-success"></i>  退票操作完成(退款中)
                    </el-col>
                        ...
                        <el-col :span="24">
                            ...
                            <el-form ref="form" label-width="180px">
                                <el-form-item label="成人单价:">
                                    ...
                                    <el-col :span="7">退票:({{tabledata.adultNumber}})人</el-col>
                                </el-form-item>
                                <el-form-item label="儿童单价:">
                                    ...
                                    <el-col :span="7">退票:({{tabledata.childNumber}})人</el-col>
                                </el-form-item>
                                <el-form-item label="退票收取总价:">
                                    <el-col :span="9">
                                ...
                                <el-form-item label="退票价格时效:">
                                    <span v-if="remainingTimeStr != '' && tabledata.mainStatus==2">剩余确认时间：<span style="color:red;font-size:16px;">{{remainingTimeStr}}</span></span>
                                    请在【{{answer.expiryTime}}】前确认是否进行退票，否则退票自动取消
                                </el-form-item>
                                <el-form-item label="退票方案:">
                    ...
                    <el-row>
                        <el-col v-show="tabledata.mainStatus==2 && remainingTimeStr != ''">
                            ...
                            <el-button type="warning" style="float: right;margin-right:20px;width:90px;"
                                       @click="agreeRefund">同意退票
                            </el-button>
                            <el-button type="warning" style="float: right;margin-right:20px;width:90px;"
                                       @click="cancelRefund">取消退票
                            </el-button>
                        </el-col>
                        <el-col v-show="tabledata.mainStatus==3">
                            <el-button type="warning" style="float: right;margin-right:20px;">退票成功提交，请等待处理结果</el-button>
                        </el-col>

                        <el-col v-show="tabledata.mainStatus==4||(tabledata.mainStatus==2&&remainingTimeStr == '')">
                            <el-button type="danger" style="float: right;margin-right:20px;width:120px;">退票已取消
                            </el-button>
                        </el-col>
            ...
            <el-card class="box-card" v-else>
                <header style="text-align:center">等待退票方案中</header>
            </el-card>
            <!--订单基本信息-->
                ...
                <div class="passenger_info">
                    <el-table :data="passengers" ref="multipleTable2" style="width: 100%">
                        ...
                        <el-table-column prop="ticketNo" label="票号">
                                 <template scope="scope">
                                        <div :key="ticket.ticketNo" v-for="ticket in scope.row.tickets">
